...
const en = {
  ...
  announcementSettings: {
    ...
    libraryDocsEmpty: 'No documents available',
  ...
  librarySettings: {
    ...
    libraryNameRequired: 'Please select a library name',
    libraryNamePlaceholder: 'Select a library',
    loadingLibraries: 'Loading libraries...',
    noLibraryForCountry: 'No global libraries yet, please add one',
    ...
    replaceFileHint: 'Save to replace the current file with the selected one',
    replaceFileHintEmpty: 'Select a file to replace the current attachment (takes effect on save)',
    documentCount: '{count} Documents',
    noDocuments: 'No documents',
    deleteDocument: 'Are you sure you want to delete this document?',
    deleteDocumentHint: 'This will also remove all distribution rules and physical files. This action cannot be undone.',
    deleteAttachmentConfirm: 'Are you sure you want to delete attachment "{name}"?',
    deleteLibraryConfirm: 'Are you sure you want to delete empty library "{name}"?',
    deleteLibraryBtn: 'Delete Library',
    deleteLibraryDisabledHint: 'Remove all distribution rules before deleting this library.',
    ...
    addNewLibraryHint: 'Enter a new global library name. You can upload documents and set distribution rules in "Document Management".',
    noCatalogs: 'No global libraries yet. Click "Add Library" to create one.',
    // Edit library
    ...
    distributionSettingsHint: 'Select which countries this document should be distributed to, and configure the library and access rules for each country.',
    addDistribution: 'Add Country',
    editDistribution: 'Edit Distribution Rules',
    distributionCountry: 'Country',
    distributionCatalog: 'Library',
    distributionAuthRules: 'Access Rules',
    distributionActive: 'Active',
    noDistribution: 'No distribution rules configured',
    distributionUpdated: 'Distribution rules updated',
    distributionUpdateFailed: 'Failed to update distribution rules',
    distributionCountryRequired: 'Please select a country',
    distributionCatalogRequired: 'Please select a library for the following countries: {countries}',
    distributionCountryExists: 'This country already has a distribution rule, please edit it directly',
    // Access rules
    accessPublic: 'Public (visible to all)',
    accessRestricted: 'Restricted Users',
    accessRestrictedHint: 'Only the selected users below can access this document',
    accessPublicHint: 'All users can access this document',
    enableAccessRestriction: 'Enable Access Restriction',
    selectedCount: '{count} selected',
    atLeastOneUser: 'Please select at least one user, or disable the access restriction toggle',
    // Distribution status column
    distributedCountries: 'Distributed Countries',
    noDistributedCountries: 'Not distributed',
    ...
    leaveConfirmDiscard: 'Discard',
    leaveConfirmContinue: 'Keep Editing',
    // Library management (per country)
    filterByCountry: 'All Countries',
    catalogCountryLabel: 'Country',
    catalogCountryPlaceholder: 'Select the country for this library',
    catalogCountryRequired: 'Please select the country for this library',
    libraryDescPlaceholder: 'Library description (optional)',
  },
